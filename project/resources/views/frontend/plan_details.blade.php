                            ...
                            <div class="billing-item-lists">
                                <ul>
                                    ...
                                    @if (auth()->user()->plan_id != NULL && auth()->user()->plan_end_date>now())
                                        <li><span class="prt-title">@lang('Start Date'):</span><span class="prt-value">{{ auth()->user()->plan_end_date->format('d-m-Y') }}</span></li>
                                        <li><span class="prt-title">@lang('Expiry Date'):</span><span class="prt-value">{{ auth()->user()->plan_end_date->addDays($data->post_duration)->format('d-m-Y') }}</span></li>
                                    @else

    ...
    Route::get('/cache/clear', function() {
     ...
     Route::group(['middleware'=>'permissions:Directory Enquiry'],function(){
      ...
      Route::get('/taxes/delete/{id}', [TaxController::class,'destroy'])->name('admin.taxes.delete');
        ...
        Route::get('/users/import', [UserController::class,'import'])->name('admin-user-import');   //import data
        Route::post('/users/import', [UserController::class,'importData'])->name('admin-user-import-data');
